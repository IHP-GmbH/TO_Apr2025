...
color=4
node=i(vdd)}
B 2 1890 -350 3540 400 {flags=graph,unlocked
...
N 2640 -1060 2640 -950 {lab=#net8}
N 2640 -810 2640 -700 {lab=#net9}
N 2540 -820 2570 -820 {lab=#net10}
N 2540 -940 2570 -940 {lab=#net11}
N 2190 -890 2570 -890 {lab=Q1}
N 2150 -870 2570 -870 {lab=nQ1}
N 2860 -990 2860 -940 {lab=#net11}
N 2960 -1060 2960 -950 {lab=#net12}
N 2960 -810 2960 -700 {lab=#net13}
N 2860 -820 2890 -820 {lab=#net10}
N 2860 -940 2890 -940 {lab=#net11}
N 2540 -990 2860 -990 {lab=#net11}
N 2540 -770 2860 -770 {lab=#net10}
N 2860 -820 2860 -770 {lab=#net10}
N 2710 -890 2890 -890 {lab=Q2}
N 2710 -870 2890 -870 {lab=nQ2}
N 3180 -990 3180 -940 {lab=#net11}
N 3280 -1060 3280 -950 {lab=#net14}
N 3280 -810 3280 -700 {lab=#net15}
N 3180 -820 3210 -820 {lab=#net10}
N 3180 -940 3210 -940 {lab=#net11}
N 2860 -990 3180 -990 {lab=#net11}
N 2860 -770 3180 -770 {lab=#net10}
N 3180 -820 3180 -770 {lab=#net10}
N 3030 -890 3210 -890 {lab=Q3}
N 3030 -870 3210 -870 {lab=nQ3}
N 3500 -990 3500 -940 {lab=#net11}
N 3600 -1060 3600 -950 {lab=#net16}
N 3600 -810 3600 -700 {lab=#net17}
N 3500 -820 3530 -820 {lab=#net10}
N 3500 -940 3530 -940 {lab=#net11}
N 3180 -990 3500 -990 {lab=#net11}
N 3180 -770 3500 -770 {lab=#net10}
N 3500 -820 3500 -770 {lab=#net10}
N 3350 -890 3530 -890 {lab=Q4}
N 3350 -870 3530 -870 {lab=nQ4}
N 3820 -990 3820 -940 {lab=#net11}
N 3920 -1060 3920 -950 {lab=#net18}
N 3920 -810 3920 -700 {lab=#net19}
N 3820 -820 3850 -820 {lab=#net10}
N 3820 -940 3850 -940 {lab=#net11}
N 3500 -990 3820 -990 {lab=#net11}
N 3500 -770 3820 -770 {lab=#net10}
N 3820 -820 3820 -770 {lab=#net10}
N 3670 -890 3850 -890 {lab=Q5}
N 3670 -870 3850 -870 {lab=nQ5}
N 3990 -890 4060 -890 {lab=Q6}
N 3990 -870 4060 -870 {lab=nQ6}
...
N 2520 -770 2540 -770 {lab=#net10}
N 2540 -820 2540 -770 {lab=#net10}
N 2540 -990 2540 -940 {lab=#net11}
N 2320 -740 2320 -700 {lab=#net24}
N 2480 -1060 2480 -1020 {lab=#net25}
N 2320 -940 2320 -800 {lab=#net11}
N 2380 -990 2540 -990 {lab=#net11}
N 2480 -820 2480 -800 {lab=#net10}
N 1920 -820 1980 -820 {lab=#net4}
N 1920 -960 1920 -820 {lab=#net4}
N 2480 -820 2540 -820 {lab=#net10}
N 2480 -960 2480 -820 {lab=#net10}
N 2380 -990 2380 -940 {lab=#net11}
N 2360 -990 2380 -990 {lab=#net11}
N 2320 -940 2380 -940 {lab=#net11}
N 2320 -960 2320 -940 {lab=#net11}
...
savecurrent=true
lvs_ignore=short}
C {tcleval([xschem get current_dirname]/static_div2_lv_mos.sym} 2640 -880 0 0 {name=x2
schematic="tcleval([xschem get current_dirname]/static_div2_lv_mos.sch"
nw=0.15u
nl=0.13u
pw=0.3u
pl=0.13u}
C {pwroli.sym} 2640 -1120 2 1 {name=l9 lab=VDD
}
C {ammeter.sym} 2640 -1090 0 1 {name=Vddd3
savecurrent=true
lvs_ignore=short}
C {pwroli.sym} 2640 -640 0 0 {name=l10 lab=VSS}
C {ammeter.sym} 2640 -670 0 1 {name=Vsss3
savecurrent=true
lvs_ignore=short}
C {lab_pin.sym} 2780 -870 1 1 {name=p13 lab=nQ2  net_name=true}
C {lab_pin.sym} 2780 -890 3 1 {name=p14 lab=Q2  net_name=true}
C {tcleval([xschem get current_dirname]/static_div2_lv_mos.sym} 2960 -880 0 0 {name=x3
schematic="tcleval([xschem get current_dirname]/static_div2_lv_mos.sch"
nw=0.15u
nl=0.13u
pw=0.3u
pl=0.13u}
C {pwroli.sym} 2960 -1120 2 1 {name=l33 lab=VDD
}
C {ammeter.sym} 2960 -1090 0 1 {name=Vddd4
savecurrent=true
lvs_ignore=short}
C {pwroli.sym} 2960 -640 0 0 {name=l34 lab=VSS}
C {ammeter.sym} 2960 -670 0 1 {name=Vsss11
savecurrent=true
lvs_ignore=short}
C {lab_pin.sym} 3100 -870 1 1 {name=p2 lab=nQ3  net_name=true}
C {lab_pin.sym} 3100 -890 3 1 {name=p3 lab=Q3  net_name=true}
C {tcleval([xschem get current_dirname]/static_div2_lv_mos.sym} 3280 -880 0 0 {name=x4
schematic="tcleval([xschem get current_dirname]/static_div2_lv_mos.sch"
nw=0.15u
nl=0.13u
pw=0.3u
pl=0.13u}
C {pwroli.sym} 3280 -1120 2 1 {name=l11 lab=VDD
}
C {ammeter.sym} 3280 -1090 0 1 {name=Vddd5
savecurrent=true
lvs_ignore=short}
C {pwroli.sym} 3280 -640 0 0 {name=l12 lab=VSS}
C {ammeter.sym} 3280 -670 0 1 {name=Vsss4
savecurrent=true
lvs_ignore=short}
C {lab_pin.sym} 3420 -870 1 1 {name=p6 lab=nQ4  net_name=true}
C {lab_pin.sym} 3420 -890 3 1 {name=p7 lab=Q4  net_name=true}
C {tcleval([xschem get current_dirname]/static_div2_lv_mos.sym} 3600 -880 0 0 {name=x5
schematic="tcleval([xschem get current_dirname]/static_div2_lv_mos.sch"
nw=0.15u
nl=0.13u
pw=0.3u
pl=0.13u}
C {pwroli.sym} 3600 -1120 2 1 {name=l13 lab=VDD
}
C {ammeter.sym} 3600 -1090 0 1 {name=Vddd6
savecurrent=true
lvs_ignore=short}
C {pwroli.sym} 3600 -640 0 0 {name=l14 lab=VSS}
C {ammeter.sym} 3600 -670 0 1 {name=Vsss5
savecurrent=true
lvs_ignore=short}
C {lab_pin.sym} 3740 -870 1 1 {name=p9 lab=nQ5  net_name=true}
C {lab_pin.sym} 3740 -890 3 1 {name=p10 lab=Q5 net_name=true}
C {tcleval([xschem get current_dirname]/static_div2_lv_mos.sym} 3920 -880 0 0 {name=x6
schematic="tcleval([xschem get current_dirname]/static_div2_lv_mos.sch"
nw=0.15u
nl=0.13u
pw=0.3u
pl=0.13u}
C {pwroli.sym} 3920 -1120 2 1 {name=l15 lab=VDD
}
C {ammeter.sym} 3920 -1090 0 1 {name=Vddd7
savecurrent=true
lvs_ignore=short}
C {pwroli.sym} 3920 -640 0 0 {name=l16 lab=VSS}
C {ammeter.sym} 3920 -670 0 1 {name=Vsss6
savecurrent=true
lvs_ignore=short}
C {lab_pin.sym} 4060 -870 1 1 {name=p16 lab=nQ6  net_name=true}
C {lab_pin.sym} 4060 -890 3 1 {name=p17 lab=Q6  net_name=true}
