...
N 460 -1410 460 -1390 {lab=VDD}
N 240 -1280 290 -1280 {lab=v_ind}
N 480 -1310 540 -1310 {lab=v_ind}
N 480 -1330 480 -1310 {lab=v_ind}
N 540 -1360 540 -1310 {lab=v_ind}
N 520 -1360 540 -1360 {lab=v_ind}
N 460 -1410 480 -1410 {lab=VDD}
N 480 -1460 480 -1410 {lab=VDD}
N 240 -1440 320 -1440 {
lab=VDD}
N 320 -1520 320 -1440 {
lab=VDD}
N 1520 -1410 1520 -1390 {lab=VDD}
N 1540 -1410 1540 -1390 {lab=VDD}
N 1520 -1410 1540 -1410 {lab=VDD}
N 1520 -1460 1520 -1410 {lab=VDD}
N 1840 -1330 1840 -1310 {lab=VDD}
N 1860 -1330 1860 -1310 {lab=VDD}
N 1840 -1330 1860 -1330 {lab=VDD}
N 1840 -1460 1840 -1330 {lab=VDD}
...
N 2160 -1410 2160 -1390 {lab=VDD}
N 2180 -1410 2180 -1390 {lab=VDD}
N 2160 -1410 2180 -1410 {lab=VDD}
N 2160 -1460 2160 -1410 {lab=VDD}
N 1200 -1460 1200 -1120 {lab=VDD}
...
N 1840 -1250 1840 -1120 {lab=#net1}
N 2140 -1120 2160 -1120 {lab=#net2}
N 2060 -1120 2080 -1120 {lab=#net3}
N 2060 -1120 2060 -960 {lab=#net3}
N 2060 -960 2160 -960 {lab=#net3}
N 1820 -1120 1840 -1120 {lab=#net1}
N 1740 -1120 1760 -1120 {lab=#net4}
N 1740 -1120 1740 -960 {lab=#net4}
N 1740 -960 1840 -960 {lab=#net4}
N 1500 -1120 1520 -1120 {lab=#net5}
N 1420 -1120 1440 -1120 {lab=#net6}
N 1420 -1120 1420 -960 {lab=#net6}
N 1420 -960 1520 -960 {lab=#net6}
N 1180 -1120 1200 -1120 {lab=VDD}
N 1100 -1120 1120 -1120 {lab=VSS}
N 1100 -1120 1100 -960 {lab=VSS}
N 1100 -960 1200 -960 {lab=VSS}
N 1200 -960 1200 -620 {lab=VSS}
N 1520 -770 1520 -620 {lab=VSS}
N 1840 -960 1840 -750 {lab=#net4}
N 1840 -690 1840 -620 {lab=VSS}
N 2160 -770 2160 -620 {lab=VSS}
N 1680 -940 1680 -400 {lab=c1}
N 640 -1330 640 -1310 {lab=VDD}
N 620 -1330 620 -1310 {lab=VDD}
N 640 -1230 700 -1230 {lab=v_gain}
N 640 -1250 640 -1230 {lab=v_gain}
N 700 -1280 700 -1230 {lab=v_gain}
N 680 -1280 700 -1280 {lab=v_gain}
N 620 -1330 640 -1330 {lab=VDD}
N 700 -1280 1800 -1280 {lab=v_gain}
N 640 -1230 640 -1200 {lab=v_gain}
N 640 -1460 640 -1330 {lab=VDD}
N 240 -1200 290 -1200 {lab=v_gain}
N 540 -1360 2120 -1360 {lab=v_ind}
N 960 -690 960 -620 {lab=VSS}
N 800 -770 800 -620 {lab=VSS}
N 800 -1410 800 -1390 {lab=VDD}
N 820 -1410 820 -1390 {lab=VDD}
N 800 -1410 820 -1410 {lab=VDD}
N 800 -1460 800 -1410 {lab=VDD}
N 960 -1330 960 -1310 {lab=VDD}
N 980 -1330 980 -1310 {lab=VDD}
N 960 -1330 980 -1330 {lab=VDD}
N 960 -1460 960 -1330 {lab=VDD}
N 800 -850 800 -830 {lab=#net7}
N 960 -770 960 -750 {lab=#net8}
N 860 -800 2120 -800 {lab=#net7}
N 1020 -720 1800 -720 {lab=#net8}
N 960 -770 1020 -770 {lab=#net8}
N 960 -1250 960 -770 {lab=#net8}
N 1020 -770 1020 -720 {lab=#net8}
N 1000 -720 1020 -720 {lab=#net8}
N 860 -850 860 -800 {lab=#net7}
N 840 -800 860 -800 {lab=#net7}
N 800 -850 860 -850 {lab=#net7}
N 800 -1330 800 -850 {lab=#net7}
N 1520 -1330 1520 -1120 {lab=#net5}
N 2160 -1330 2160 -1120 {lab=#net2}
N 1520 -960 1520 -830 {lab=#net6}
N 2160 -960 2160 -830 {lab=#net3}
N 1920 -1020 1940 -1020 {lab=c2}
N 1920 -1060 1940 -1060 {lab=c1}
N 350 -1280 480 -1280 {lab=v_ind}
N 350 -1200 640 -1200 {lab=v_gain}
...
nw="tcleval([string map \{\{$\} \{\}\} [ev \{4.98e-6\}]])"
...
C {cap_cmim.sym} 1150 -1120 3 1 {name=C5
model=cap_cmim
w=15e-6
l=4e-6
m=1
spiceprefix=X}
C {cap_cmim.sym} 1470 -1120 3 1 {name=C1
model=cap_cmim
w=15e-6
l=8e-6
m=1
spiceprefix=X}
C {cap_cmim.sym} 1790 -1120 3 1 {name=C2
model=cap_cmim
w=15e-6
l=8e-6
m=1
spiceprefix=X}
C {cap_cmim.sym} 2110 -1120 3 1 {name=C3
model=cap_cmim
w=15e-6
l=8e-6
m=1
spiceprefix=X}
C {launcher.sym} 600 -400 0 0 {name=h3
descr="write LVS netlist"
tclcommand="
	xschem set netlist_type spice
	set lvs_ignore 1
