...
logx=1
logy=1}
B 2 940 -690 1570 -360 {flags=graph,unlocked
...
B 2 3040 -1840 3670 -1510 {flags=graph,unlocked
...
n5
CM5"}
B 2 1760 -1790 2390 -1460 {flags=graph,unlocked
...
[xschem raw info])} 940 -340 0 0 0.3 0.3 {floater=true layer=16}
N 800 -290 800 -270 {
lab=VSS}
N 800 -530 800 -510 {
lab=VDD}
...
N 2240 -440 2330 -440 {lab=#net4}
N 2160 -440 2240 -440 {lab=#net4}
N 2160 -450 2160 -440 {lab=#net4}
N 2470 -440 2800 -440 {lab=CM5}
N 2470 -500 2560 -500 {lab=P5}
N 2640 -520 2800 -520 {lab=N5}
N 2640 -520 2640 -500 {lab=N5}
N 2470 -520 2640 -520 {lab=N5}
N 2560 -600 2560 -500 {lab=P5}
N 2640 -600 2800 -600 {lab=P5}
N 2400 -410 2400 -380 {lab=#net6}
N 2240 -1880 2240 -1870 {lab=#net7}
N 2240 -1810 2240 -1800 {lab=#net8}
N 2400 -1940 2400 -1910 {lab=#net9}
N 2160 -1880 2160 -1870 {lab=#net7}
N 2240 -1880 2330 -1880 {lab=#net7}
N 2160 -1880 2240 -1880 {lab=#net7}
N 2240 -1800 2330 -1800 {lab=#net8}
N 2160 -1800 2240 -1800 {lab=#net8}
N 2160 -1810 2160 -1800 {lab=#net8}
N 2470 -1800 2800 -1800 {lab=#net10}
N 2470 -1860 2560 -1860 {lab=#net11}
N 2640 -1880 2800 -1880 {lab=#net12}
N 2640 -1880 2640 -1860 {lab=#net12}
N 2470 -1880 2640 -1880 {lab=#net12}
N 2560 -1960 2560 -1860 {lab=#net11}
N 2640 -1960 2860 -1960 {lab=#net11}
N 2400 -1770 2400 -1740 {lab=#net13}
N 2860 -1960 2860 -1880 {lab=#net11}
N 2640 -600 2640 -590 {lab=P5}
N 2560 -600 2640 -600 {lab=P5}
N 2640 -530 2640 -520 {lab=N5}
N 2640 -1960 2640 -1950 {lab=#net11}
N 2640 -1890 2640 -1880 {lab=#net12}
N 2560 -1960 2640 -1960 {lab=#net11}
C {title.sym} 160 -30 0 0 {name=l1 author="om"  net_name=true}
C {vsource.sym} 800 -480 0 0 {name=VDD value="1.3 pulse(1.8 .8 0 100n 100n 100n)" net_name=true
}
...
C {lab_pin.sym} 2800 -600 2 0 {name=p7 lab=P5  net_name=true}
C {lab_pin.sym} 2800 -520 2 0 {name=p14 lab=N5 net_name=true}
...
C {vsource.sym} 2830 -1880 1 0 {name=Vac5 value="0 ac 1 0"  net_name=true
}
C {lab_pin.sym} 2800 -440 2 0 {name=p16 lab=CM5  net_name=true}
C {capa.sym} 2830 -1800 1 0 {name=C15
m=1
value=1n

footprint=1206
device="ceramic capacitor"}
C {pwroli.sym} 2920 -1800 3 1 {name=l76 lab=VSS}
C {vsource.sym} 2890 -1800 1 0 {name=Vac6 value="0 ac 1 0"  net_name=true
}
C {tcleval([xschem get current_dirname]//VCO_schmitz_hampel_01.sym} 2400 -480 0 0 {name=x1}
...
savecurrent=true
lvs_ignore=short}
C {capa.sym} 2240 -1940 2 0 {name=C4
m=1
value=100f
...
C {tcleval([xschem get current_dirname]//VCO_schmitz_hampel_01.sym} 2400 -1840 0 0 {name=x2}
C {pwroli.sym} 2400 -1680 0 0 {name=l20 lab=VSS}
C {ammeter.sym} 2400 -1710 0 1 {name=Vsss10
savecurrent=true
lvs_ignore=short}
C {sg13g2_pr/cap_cmim.sym} 2240 -1840 0 0 {name=C1
model=cap_cmim
w=20e-6
l=10e-6
m=1
spiceprefix=X}
C {capa.sym} 2240 -580 2 0 {name=C2
m=1
value=100f
...
device="ceramic capacitor"
spice_ignore=true}
C {sg13g2_pr/cap_cmim.sym} 2240 -480 0 0 {name=C8
model=cap_cmim
w=5e-6
l=5e-6
m=1
spiceprefix=X}
C {sg13g2_pr/cap_cmim.sym} 2640 -560 0 0 {name=C9
model=cap_cmim
w=5e-6
l=5e-6
m=1
spiceprefix=X}
C {sg13g2_pr/cap_cmim.sym} 2640 -1920 0 0 {name=C10
model=cap_cmim
w=5e-6
l=5e-6
m=1
spiceprefix=X
spice_ignore=true}
C {sg13g2_pr/rppd.sym} 2560 -1830 0 0 {name=R4
w=0.5e-6
l=3e-6
model=rppd
spiceprefix=X
...
C {sg13g2_pr/rppd.sym} 2640 -1830 0 0 {name=R5
w=0.5e-6
l=3e-6
model=rppd
spiceprefix=X
...
C {sg13g2_pr/rppd.sym} 2560 -470 0 0 {name=R2
w=0.5e-6
l=3e-6
model=rppd
spiceprefix=X
...
C {sg13g2_pr/rppd.sym} 2640 -470 0 0 {name=R6
w=0.5e-6
l=3e-6
model=rppd
spiceprefix=X
