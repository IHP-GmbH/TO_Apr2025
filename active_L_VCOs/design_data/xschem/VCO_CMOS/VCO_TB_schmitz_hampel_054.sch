...
C {vsource.sym} 800 -480 0 0 {name=VDD value=1.8  net_name=true
}
...
schematic="tcleval([xschem get current_dirname]/VCO_schmitz_hampel_10.sch)"}
...
savecurrent=true
lvs_ignore=short}
C {vsource.sym} 880 -480 0 0 {name=VCO value="0 pulse(0 1.8 0 100n 100n 100n 1)"  net_name=true
}
